...
public class Rest {
    ...
    public static void setup(String request) {
        try {
            ...
            Log.v("shop", "REST SETUP ERROR" + e.getMessage());
        }
    }
    ...
    public static String get(String url) {
        ...
        try {
            ...
            Log.v("shop", "GET REQUEST is : " + httpCon.getRequestMethod() + " " + httpCon.getURL());
            ...
            reader.close();
            Log.v("shop", "JSON GET REQUEST : " + stringBuilder.toString());

        } catch (Exception e) {
            Log.v("shop","GET REQUEST ERROR" + e.getMessage());
        }
